      ...
      <div class="">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2><i class="fa fa-sort"></i>&nbsp;Setting</h2>
              ...
              <div id="contentLeft">
               <ul>
                    ...
                    if($location_details!='')
                    {
                      ...
                      ?>
                    <li id="recordsArray_<?=$id?>"><?=$location?></li>
                    <?php
                          }
                    }
                    else
    ...
    jQuery(document).ready(function(){ 
        jQuery(function() {
            ...
            jQuery("#contentLeft ul").sortable({ opacity: 0.6, cursor: 'move', update: function() {
                ...
                jQuery.post("<?php echo base_url(); ?>admin/location/updateLocationFlag", order, function(theResponse){

...
class Common_model extends CI_Model {
    ...
    public function AllRecordWithFIND_IN($table, $inFieldId, $inField, $where = null) {
...
//        $this->db->get();       echo $this->db->last_query();       exit;    
 return $this->db->get();		
    ...
    public function getRecordWithWhereOrderby($table=null,$where,$orderField=null,$orderBy=null) {
        $this->db->select('*');
		$this->db->where($where);
		$this->db->from($table);
  ...
  public function AllRecordWithWhereOrderby($table=null,$orderField=null,$orderBy=null,$whereField=null) {
        $this->db->select('*');
		if($whereField!=null)
		{

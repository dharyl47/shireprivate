            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                <table id="datatable-fixed-header_booking" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    <?php
                      if($bookingdeparture_details!='')
					  {
						  foreach($bookingdeparture_details as $values)
						  {
                    ...
                    <tr class="<?=$class?>">
                      ...
                      <td>
                          <a href="<?php echo base_url(); ?>admin/booking/details/<?=$id?>" target="_blank">
                              <button class="btn btn-default btn-xs" type="button">
                                <span aria-hidden="true" class="glyphicon glyphicon-eye-open"></span> View
                               </button>
                          </a>
                          <a href="<?php echo base_url(); ?>admin/booking/delete/<?=$id?>" onclick="return confirm('Are you sure you want to delete?')">
                            <button class="btn btn-default btn-xs" type="button">

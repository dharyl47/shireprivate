...
foreach($bookingdeparture_details as $row)
{
	...
	$new_flag=stripslashes($row['new_flag']);
	    ...
	    $total_quotation = stripslashes($row['total_quotation']);
    $rear_facing_seat = $row['rear_facing_seat'] ? 'Yes' : 'No';
    $forward_facing_seat_harness = $row['forward_facing_seat_harness'] ? 'Yes' : 'No';
    $booster_seat = $row['booster_seat'] ? 'Yes' : 'No';
    $surfboards = $row['surfboards'] ? 'Yes' : 'No';
    $golf_clubs = $row['golf_clubs'] ? 'Yes' : 'No';
    $skis = $row['skis'] ? 'Yes' : 'No';
    $snowboards = $row['snowboards'] ? 'Yes' : 'No';
    $prams = $row['prams'] ? 'Yes' : 'No';
    $bike_cases = $row['bike_cases'] ? 'Yes' : 'No';
    $other_items = $row['other_items'] ? 'Yes' : 'No';
	$controllerInstance->updateDepartureFlag($id);
...
<div class="item form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Total Quotation</label>
    <div class="col-md-6 col-sm-6 col-xs-12">: <?= $total_quotation ?></div>
</div>
<div class="clearfix"></div>

<div class="item form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Rear Facing Seat</label>
    <div class="col-md-6 col-sm-6 col-xs-12">: <?= $rear_facing_seat ?></div>
</div>
<div class="clearfix"></div>

<div class="item form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Forward Facing Seat Harness</label>
    <div class="col-md-6 col-sm-6 col-xs-12">: <?= $forward_facing_seat_harness ?></div>
</div>
<div class="clearfix"></div>

<div class="item form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Booster Seat</label>
    <div class="col-md-6 col-sm-6 col-xs-12">: <?= $booster_seat ?></div>
</div>
<div class="clearfix"></div>

<!-- Create a new section with title 'Infant Requested seat' -->
<div class="x_title">
    <h2>Infant Requested Seat</h2>
    <div class="clearfix"></div>
</div>

<div class="item form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Surfboards</label>
    <div class="col-md-6 col-sm-6 col-xs-12">: <?= $surfboards ?></div>
</div>
<div class="clearfix"></div>

<div class="item form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Golf Clubs</label>
    <div class="col-md-6 col-sm-6 col-xs-12">: <?= $golf_clubs ?></div>
</div>
<div class="clearfix"></div>

<div class="item form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Skis</label>
    <div class="col-md-6 col-sm-6 col-xs-12">: <?= $skis ?></div>
</div>
<div class="clearfix"></div>

<div class="item form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Snowboards</label>
    <div class="col-md-6 col-sm-6 col-xs-12">: <?= $snowboards ?></div>
</div>
<div class="clearfix"></div>

<div class="item form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Prams</label>
    <div class="col-md-6 col-sm-6 col-xs-12">: <?= $prams ?></div>
</div>
<div class="clearfix"></div>

<div class="item form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Bike Cases</label>
    <div class="col-md-6 col-sm-6 col-xs-12">: <?= $bike_cases ?></div>
</div>
<div class="clearfix"></div>

<div class="item form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Other Items</label>
    <div class="col-md-6 col-sm-6 col-xs-12">: <?= $other_items ?></div>
</div>
<div class="clearfix"></div>

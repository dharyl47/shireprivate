...
foreach($slider_details as $row)
{
	...
	$sub_image=stripslashes($row['sub_image']);
	
	$text_one=stripslashes($row['text_one']);
	
	$text_two=stripslashes($row['text_two']);
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <form method="post" class="form-horizontal form-label-left"  enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/slider/update_slider">
                  ...
                  <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    ...
                    <div id="myTabContent" class="tab-content">
                      ...
                      <div class="item form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Text One</label> 
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control col-md-7 col-xs-12" id="text_one" name="text_one" value="<?=$text_one?>">
                          </div>
                        </div>
                        
                        <div class="item form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Text Two</label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control col-md-7 col-xs-12" id="text_two" name="text_two" value="<?=$text_two?>">
                          </div>
                        </div>
                    ...
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Main Image  </label>

                    <div class="col-md-6 col-sm-6 col-xs-12">

                          <input type="file" name="slider_img" id="slider_img"  class="col-md-12 col-xs-12">
                  ...
                  <div class="item form-group">
                       <label class="control-label col-md-3 col-sm-3 col-xs-12"></label>
                       <div class="col-md-6 col-sm-6 col-xs-12">
                          	<img src="<?php echo base_url(); ?>upload/slider/<?=$image?>" width="100">
                          </div>
                      </div>
                     <?php
				  }
                    ...
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Sub Image  </label>

                    <div class="col-md-6 col-sm-6 col-xs-12">

                          <input type="file" name="slider_sub_img" id="slider_sub_img"  class="col-md-12 col-xs-12">
							<input type="hidden" name="hid_sub_img" value="<?=$sub_image?>">
                  ...
                  <div class="item form-group">
                       <label class="control-label col-md-3 col-sm-3 col-xs-12"></label>
                       <div class="col-md-6 col-sm-6 col-xs-12">
                          	<img src="<?php echo base_url(); ?>upload/slider/<?=$sub_image?>" width="100">
                          </div>
                      </div>
                     <?php
				  }
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-md-offset-3"> 
                      ...
                      <a href="<?php echo base_url(); ?>admin/slider/list" class="btn btn-default">Cancel</a>

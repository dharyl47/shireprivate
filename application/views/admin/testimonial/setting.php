               ...
               <ul>
					...
					if($testimonial_details!='')
					{
						foreach($testimonial_details as $row)
						{
							...
							$author=stripslashes($row['client_name']);
							$content=stripslashes($row['comment']);
							 
							  
					  ?>
                    <li id="recordsArray_<?=$id?>"><p><?=$content?></p>
                    <p>................................................................................................................................</p>
                    <p><strong><?=$author?></strong></p></li>
	...
	jQuery(document).ready(function(){ 
		...
		jQuery(function() {
			...
			jQuery("#contentLeft ul").sortable({ opacity: 0.6, cursor: 'move', update: function() {
				...
				jQuery.post("<?php echo base_url(); ?>admin/testimonial/updateTestimonialFlag", order, function(theResponse){

          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <form method="post" class="form-horizontal form-label-left"  enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/testimonial/updateTestimonial">
                      ...
                      <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                        ...
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input class="form-control col-md-7 col-xs-12" id="client_name" name="client_name" placeholder="Client Name" value="<?=$client_name?>"  type="text">
                        ...
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <textarea class="form-control col-md-7 col-xs-12" name="comment" id="comment"><?=$comment?>
